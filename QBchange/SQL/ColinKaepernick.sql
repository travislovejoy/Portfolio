Create VIEW ColinKaepernick AS
...
WHERE full_name= 'Colin Kaepernick'
AND pp.team = 'SF'
...
\COPY (Select * from ColinKaepernick) TO '/home/travis/NFL/Analysis/QBchange/Data/ColinKaepernick.csv' DELIMITER ',' CSV HEADER;
Drop View ColinKaepernick;
